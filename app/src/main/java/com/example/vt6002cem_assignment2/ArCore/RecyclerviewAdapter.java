...
public class RecyclerviewAdapter extends RecyclerView.Adapter<RecyclerviewAdapter.ViewHolder>{
    ...
    public RecyclerviewAdapter(Context context, ArrayList<String> textNames, ArrayList<String> imagesPath, ArrayList<String> modelNames) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        //Set image
        Picasso.with(context).load(imagesPath.get(position)).into(holder.imageView);
        //Set product name
